...
export const COURSES: Course[] = [
  ...
  {
  id: "biotech",
  title: "Biotech & Bioinformatics",
  category: "Biotech",
  rating: 4.6,
  students: 3200,
  duration: "12 weeks",
  level: "Intermediate",
  priceInr: 14999, originalInr: 24999,
  livePriceInr: 29999, liveOriginalInr: 44999,
  gradient: "from-green-500 via-lime-500 to-emerald-500",
  emoji: "🧬",
  tagline: "Bridge biology with data & tech.",
  description: "Learn genomics, bioinformatics tools, and computational biology used in modern research and pharma industries.",
  highlights: [
    "Genomics & DNA sequencing basics",
    "Bioinformatics tools (BLAST, Python)",
    "Real research datasets",
    "Industry applications in pharma"
  ],
  syllabus: [
    { title: "Biology Basics", lessons: ["DNA/RNA", "Proteins", "Genetics"] },
    { title: "Bioinformatics", lessons: ["Sequence analysis", "Tools", "Python basics"] },
  ],
  instructor: { name: "Dr. Neeraj Singh", role: "Biotech Researcher", initials: "NS", bio: "Worked on genomics research projects globally." },
  classes: DEFAULT_CLASSES, tests: DEFAULT_TESTS, reviews: REVIEWS_POOL,
},
{
  id: "engineering",
  ...
  duration: "18 weeks",
  level: "Intermediate",
  priceInr: 16999, originalInr: 29999,
  livePriceInr: 34999, liveOriginalInr: 49999,
  gradient: "from-gray-600 via-slate-600 to-gray-800",
  emoji: "⚙️",
  tagline: "Strengthen core engineering fundamentals.",
  description: "Master core engineering concepts for mechanical, electrical, and civil domains with real-world applications.",
  highlights: [
    "Concept clarity for exams & jobs",
    "Real-world case studies",
    "Problem-solving sessions"
  ],
  syllabus: [
    { title: "Core Concepts", lessons: ["Mechanics", "Thermodynamics", "Circuits"] },
  ],
  instructor: { name: "Amit Sharma", role: "Senior Engineer", initials: "AS", bio: "10+ years industry experience." },
  classes: DEFAULT_CLASSES, tests: DEFAULT_TESTS, reviews: REVIEWS_POOL,
},
{
  id: "management",
  ...
  duration: "10 weeks",
  level: "Beginner",
  priceInr: 12999, originalInr: 21999,
  livePriceInr: 25999, liveOriginalInr: 39999,
  gradient: "from-yellow-500 via-orange-500 to-red-500",
  emoji: "📊",
  tagline: "Think like a business leader.",
  description: "Learn business strategy, operations, marketing, and leadership skills used in top companies.",
  highlights: [
  ...
  syllabus: [
    { title: "Business Basics", lessons: ["Marketing", "Finance", "Operations"] },
  ],
  instructor: { name: "Ritika Jain", role: "MBA, Consultant", initials: "RJ", bio: "Worked with top consulting firms." },
  classes: DEFAULT_CLASSES, tests: DEFAULT_TESTS, reviews: REVIEWS_POOL,
},
{
  id: "marketing",
  ...
  level: "Beginner",
  priceInr: 9999, originalInr: 17999,
  livePriceInr: 19999, liveOriginalInr: 29999,
  gradient: "from-pink-500 via-rose-500 to-red-500",
  emoji: "📈",
  tagline: "Grow brands with modern marketing.",
  description: "Learn SEO, social media marketing, ads, content strategy, and growth hacking.",
  highlights: [
    "SEO + Google Ads",
  ...
  syllabus: [
    { title: "Core Marketing", lessons: ["SEO", "Social media", "Ads"] },
  ],
  instructor: { name: "Ankit Mehra", role: "Growth Marketer", initials: "AM", bio: "Scaled multiple startups." },
  classes: DEFAULT_CLASSES, tests: DEFAULT_TESTS, reviews: REVIEWS_POOL,
},
{
  id: "data-analytics",
  ...
  description: "Learn Excel, SQL, Power BI, and Python for real-world analytics jobs.",
  highlights: [
    "Excel to advanced analytics",
    "SQL mastery",
    "Dashboard projects",
    "Job-ready portfolio"
  ],
  syllabus: [
    { title: "Tools", lessons: ["Excel", "SQL", "Power BI"] },
  ],
  instructor: { name: "Sanya Gupta", role: "Data Analyst", initials: "SG", bio: "Worked with top analytics firms." },
  classes: DEFAULT_CLASSES, tests: DEFAULT_TESTS, reviews: REVIEWS_POOL,
},
{
  id: "ui-ux-advanced",
  ...
  level: "Intermediate",
  priceInr: 13999, originalInr: 22999,
  livePriceInr: 27999, liveOriginalInr: 39999,
  gradient: "from-fuchsia-500 via-pink-500 to-rose-500",
  emoji: "🧠",
  tagline: "Design like top product teams.",
  description: "Master UX research, usability testing, and advanced design systems.",
  highlights: [
  ...
  syllabus: [
    { title: "UX Advanced", lessons: ["Research", "Testing", "Systems"] },
  ],
  instructor: { name: "Neha Arora", role: "UX Lead", initials: "NA", bio: "Ex-Adobe designer." },
  classes: DEFAULT_CLASSES, tests: DEFAULT_TESTS, reviews: REVIEWS_POOL,
},
{
  id: "game-dev",
  ...
  emoji: "🎮",
  tagline: "Build your own games from scratch.",
  description: "Learn Unity, C#, physics engines, and publish your own games.",
  highlights: [
    "2D & 3D games",
  ...
  syllabus: [
    { title: "Game Basics", lessons: ["Unity setup", "C#", "Game loops"] },
  ],
  instructor: { name: "Kunal Arora", role: "Game Developer", initials: "KA", bio: "Indie game developer." },
  classes: DEFAULT_CLASSES, tests: DEFAULT_TESTS, reviews: REVIEWS_POOL,
},
];
